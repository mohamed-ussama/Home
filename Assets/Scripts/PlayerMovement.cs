...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        if (player.isGrounded)
        {
            ...
            _rigidbody.AddForce(new Vector3(Input.GetAxis("Horizontal" + PlayerNum) * moveForce,
                Input.GetAxis("Jump" + PlayerNum) * jumpForce,
                -Input.GetAxis("Vertical" + PlayerNum) * moveForce));
        ...
        //_rigidbody.AddForce(new Vector3(Input.GetAxis("Jump" + PlayerNum) * moveForce, 0, -Input.GetAxis("Jump" + PlayerNum) * moveForce));
    ...
    void Update()
    {
        ...
        if (player.isGrounded)
        {
            y = Input.GetAxis("Jump" + PlayerNum) * jumpForce;
        }
        else
        {
            y = 0;
        }
        Debug.DrawRay(this.transform.position, new Vector3(Input.GetAxis("Horizontal" + PlayerNum), 
            y, 
            -Input.GetAxis("Vertical" + PlayerNum)));
